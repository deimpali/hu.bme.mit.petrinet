...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.petrinet.model.petrinetmodel.Place} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlaceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PetrinetmodelPackage.Literals.PLACE__TOKEN,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PetrinetmodelPackage.Literals.PLACE__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PetrinetmodelPackage.Literals.PLACE__OUT);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Place_type") + " " + place.getId();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PetrinetmodelPackage.Literals.PLACE__OUT,
				 PetrinetmodelFactory.eINSTANCE.createEdgeToTransaction()));
	}
