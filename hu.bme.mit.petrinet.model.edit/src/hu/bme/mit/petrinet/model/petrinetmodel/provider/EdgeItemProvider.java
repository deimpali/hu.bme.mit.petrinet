...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.petrinet.model.petrinetmodel.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PetrinetmodelPackage.Literals.EDGE__WEIGHT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Edge_type") + " " + edge.getWeight();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Edge.class)) {
			case PetrinetmodelPackage.EDGE__WEIGHT:
