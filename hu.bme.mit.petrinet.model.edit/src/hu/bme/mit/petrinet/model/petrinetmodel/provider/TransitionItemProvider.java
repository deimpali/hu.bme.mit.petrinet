...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.petrinet.model.petrinetmodel.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_token_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_token_feature", "_UI_Transition_type"),
				 PetrinetmodelPackage.Literals.TRANSITION__TOKEN,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PetrinetmodelPackage.Literals.TRANSITION__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PetrinetmodelPackage.Literals.TRANSITION__OUT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PetrinetmodelPackage.Literals.TRANSITION__OUT,
				 PetrinetmodelFactory.eINSTANCE.createEdgeToPlace()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return PetrinetModelEditPlugin.INSTANCE;
	}
